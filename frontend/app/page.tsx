    ...
    <div className="flex flex-col min-h-screen">
      <header className="border-b">
        <div className="container flex h-16 items-center justify-between min-w-full">
          ...
          <nav className="flex items-center gap-4 mx-3">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Create, conduct, and evaluate exams with the power of
                  artificial intelligence. Get instant feedback and detailed
                  analysis.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Our advanced AI algorithms evaluate responses with
                    human-like understanding and provide detailed feedback.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Reduce grading time by up to 90% while maintaining high
                    evaluation standards and consistency.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">

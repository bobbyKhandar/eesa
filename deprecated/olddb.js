"use server"
import {QuestionModel,userModel,connect} from "../backend/database/models.js"
//
export async function createExam(examName,examType,examFollowup,examMaxMarks,examPassingPercentage,examDegree,examUsers,data) {
  let examquestions=[];
  for(let key in data){

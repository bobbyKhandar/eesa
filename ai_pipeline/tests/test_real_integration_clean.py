...
class TestBatchProcessing(unittest.TestCase):
    ...
    def test_track_batch_jobs(self):
        ...
        print(f"\n Tracking {len(TestBatchProcessing.job_ids)} batch jobs...")
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            if not cls.local_available:
                print("\n Local pipeline not available - skipping local tests")
        except Exception as e:
            cls.local_available = False
            print(f"\n Could not check local pipeline availability: {e}")
...
def run_real_integration_tests():
    ...
    print(f"\n Setup validated! Starting tests...\n")
    print("=" * 80)
